...
**Early release:** targets **Hyprland main `e368c13`**, with matching development headers
...
You need Hyprland **main at `e368c13`**, its matching development headers, a matching
...
- **Version pin:** Hyprland main `e368c13` only (0.56.2 is supported by
